...
const steps = [
  {
    ...
    step: "01",
    title: "Learn",
    desc: "Access expert-curated courses, AI-powered guides, and live insights across every earning category.",
    accent: "#ffb780",
  },
  {
    icon: Hammer,
    step: "02",
    title: "Build",
    desc: "Use our premium tools to create income streams — from automated portfolios to monetized content pipelines.",
    accent: "#ffb1c1",
  },
  {
    ...
    step: "03",
    title: "Earn",
    desc: "Watch your earnings compound in real time. Scale what works. Unlock your next income level.",
    accent: "#ff8906",
  },
];
    ...
    <section className="relative py-32 px-6" id="how-it-works">
      <div className="container mx-auto max-w-5xl">
        ...
        >
          ...
          >
            How{" "}
            <span className="text-gradient-primary">EarnX Works</span>
          </h2>
        </motion.div>
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  backgroundImage: "linear-gradient(rgba(22,22,26,0.8), rgba(22,22,26,0.8))",
                  backgroundOrigin: "padding-box",
                  boxShadow: "0 8px 40px rgba(0,0,0,0.5)",
                  transition: "box-shadow 0.3s, border-color 0.3s",
                }}
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLElement).style.boxShadow = `0 0 40px ${step.accent}22, 0 8px 40px rgba(0,0,0,0.5)`;
              ...
              >
                ...
                {/* Glow line bottom */}
                <div
                  className="absolute bottom-0 left-[20%] right-[20%] h-[2px] rounded-full opacity-0 transition-opacity duration-500 group-hover:opacity-100"
