...
export function Testimonials() {
  ...
  return (
    <section className="relative py-32 px-6" id="success-stories">
      <div
        className="absolute top-1/2 left-0 pointer-events-none rounded-full -translate-y-1/2"
        style={{ width: 500, height: 400, background: "rgba(255,177,193,0.07)", filter: "blur(130px)" }}
      />
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div
              ...
              style={{ width: 300, height: 300, background: t.accent, opacity: 0.06, filter: "blur(80px)", transform: "translate(30%, -30%)" }}
            />
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex flex-col items-center md:items-start gap-4 shrink-0">
                <div
                  ...
                  style={{
                    ...
                    fontWeight: 800,
                    color: "#fffffe",
                    background: `linear-gradient(135deg, ${t.accent}80, ${t.accent}40)`,
                ...
                <div className="flex gap-0.5">
                  {Array.from({ length: t.stars }).map((_, i) => (
                    <Star key={i} size={14} className="fill-current" style={{ color: t.accent }} />
                  ))}
                </div>
              </div>
              ...
              <div className="flex-1">
                ...
                >
                  <span style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 28, color: t.accent, letterSpacing: "-0.02em" }}>
                    {t.income}
                  </span>
        ...
        <div className="flex items-center justify-center gap-6 mt-8">
          <button
            ...
            onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(255,183,128,0.4)"; }}
