          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <div className="flex flex-col gap-4">
                ...
                <ul className="flex flex-col gap-4">
                  {[
                    "Zero upfront cost — start with as little as $10",
                    "AI-powered tools automate your earnings",
                    "Real-time analytics dashboard",
                    "Active community of 127K+ members",
                    "Expert support and weekly training",
                  ].map((item, i) => (
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <div className="rounded-[24px] p-8" style={{ background: "rgba(22,22,26,0.8)", backdropFilter: "blur(40px)", border: "1px solid rgba(255,255,255,0.09)" }}>
                <h3 style={{ fontFamily: "'Syne',sans-serif", fontWeight: 700, fontSize: 22, color: "#fffffe", marginBottom: 24, textAlign: "center" }}>
                  Create Your Account
                </h3>
                ...
                {step === 1 && (
                  <div className="flex flex-col gap-4">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="btn-magnetic rounded-xl font-body font-bold py-3 mt-2"
                      style={{ color: "#fffffe", fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 15 }}
                    >
                ...
                {step === 2 && (
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-2 mt-2">
                      <motion.button onClick={() => setStep(1)} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="flex-1 rounded-xl py-3 font-body font-bold text-sm" style={{ background: "rgba(255,255,255,0.08)", color: "#a7a9be", fontFamily: "'Plus Jakarta Sans',sans-serif" }}>
                        Back
                      </motion.button>
                      <motion.button
                        onClick={() => setStep(3)}
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        className="flex-1 btn-magnetic rounded-xl font-body font-bold py-3 text-sm"
                ...
                {step === 3 && (
                  <div className="text-center">
                    ...
                    <motion.button whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }} className="btn-magnetic rounded-xl font-body font-bold py-3 px-8" style={{ color: "#fffffe", fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 15 }}>
